/* relax.cpp : Reduces local energy density by low pass filtering.
 * 
...
double affectedRho[MAX_NSIDE][MAX_NSIDE][MAX_NSIDE];  /* Ditto */
   ...
   for (int i = from_i; i <= to_i; i++)
   {
      for (int j = 0; j <= nSideM1; j++)
      {
         for (int k = 0; k <= nSideM1; k++)
         {
            ...
            double min_rho = affectedRho[i][j][k];
            ...
            privateFields[4][4][4].th_1 = lowpassed.th_1;
            privateFields[4][4][4].th_2 = lowpassed.th_2;
            privateFields[4][4][4].th_3 = lowpassed.th_3;

            compute_affected_private_derivatives(0);
            compute_affected_private_derivatives(1);
            compute_affected_private_derivatives(2);
                  
            privateAux[4][4][4].compute_hG(lowpassed.th_1, lowpassed.th_2, lowpassed.th_3);
            ...
            privateFields[4][4][4].A_1 = lowpassed.A_1;
            privateFields[4][4][4].A_2 = lowpassed.A_2;
            privateFields[4][4][4].A_3 = lowpassed.A_3;
            ...
            privateFields[4][4][4].th_1 = fields[active][i][j][k].th_1;
            privateFields[4][4][4].th_2 = fields[active][i][j][k].th_2;
            privateFields[4][4][4].th_3 = fields[active][i][j][k].th_3;
                  
            copy2affected_private_derivatives(i, j, k, 0);
            copy2affected_private_derivatives(i, j, k, 1);
            copy2affected_private_derivatives(i, j, k, 2);

            privateAux[4][4][4] = aux[i][j][k];
            ...
            {
               case conf_theta: {
                                   fields[inActive][i][j][k].th_1 = lowpassed.th_1;
                                   fields[inActive][i][j][k].th_2 = lowpassed.th_2;
                                   fields[inActive][i][j][k].th_3 = lowpassed.th_3;

                                   fields[inActive][i][j][k].A_1 = fields[active][i][j][k].A_1;
                                   fields[inActive][i][j][k].A_2 = fields[active][i][j][k].A_2;
                                   fields[inActive][i][j][k].A_3 = fields[active][i][j][k].A_3;
                                          
                                   affectedRho[i][j][k] = min_rho;

                                   break;
                                }
               case conf_a:     {
                                   fields[inActive][i][j][k].th_1 = fields[active][i][j][k].th_1;
                                   fields[inActive][i][j][k].th_2 = fields[active][i][j][k].th_2;
                                   fields[inActive][i][j][k].th_3 = fields[active][i][j][k].th_3;

                                   fields[inActive][i][j][k].A_1 = lowpassed.A_1;
                                   fields[inActive][i][j][k].A_2 = lowpassed.A_2;
                                   fields[inActive][i][j][k].A_3 = lowpassed.A_3;
               ...
               default :        {
                                   fields[inActive][i][j][k] = fields[active][i][j][k];
                                }
            }
         }
      }
...
#pragma omp for
       ...
       for (int i = 0; i <= nSideM1; i++)
           for (int j = 0; j <= nSideM1; j++)
               for (int k = 0; k <= nSideM1; k++)
                   affectedRho[i][j][k] = affected_static_rho(i, j, k);
#ifdef _OPENMP
#pragma omp barrier
}
#endif
