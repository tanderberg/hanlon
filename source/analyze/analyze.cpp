/* analyze.cpp : Analyzes raw (cartesian) field data.
 * 
...
/* Individual terms are returned in the TRho struct.  */
{
   ...
   rho.BR2 = ( pow(dy_A_3 - dz_A_2, 2) + pow(dz_A_1 - dx_A_3, 2) + pow(dx_A_2 - dy_A_1, 2) ) / 2;
...
{
   o.E_x = -dotFields[i][j][k].A_1;
   o.E_y = -dotFields[i][j][k].A_2;
   o.E_z = -dotFields[i][j][k].A_3;
   ...
   TRho rho_static;
   get_rho_static_core(&(fields[i][j][k]), h_00, h_01, h_02, h_11, h_12, h_22,
   ...
   double rGt = (  dotFields[i][j][k].ph_0 * dotFields[i][j][k].ph_0
                 ...
                 + dotFields[i][j][k].ph_3 * dotFields[i][j][k].ph_3 ) / 2;
   ...
   o.divE = -aux[i][j][k].compute_divA(i, j, k, nSideM1, dotFields);
...
#pragma omp barrier
   ...
   averages << "max dt_phi_a: " << max_dt_phi << " (" << max_dt_phi_i << ", " << max_dt_phi_j << ", " << max_dt_phi_k << ")"  << endl;
   averages << "max dt_A_a: " << max_dt_A << " (" << max_dt_A_i << ", "  << max_dt_A_j << ", "  << max_dt_A_k << ")" << endl;
   averages << "max dt_phi_a/phi_a: " << max_rel_dt_phi << " (" << max_rel_dt_phi_i << ", " << max_rel_dt_phi_j << ", " << max_rel_dt_phi_k << ")" << endl;
   averages << "max dt_A_a/A_a: " << max_rel_dt_A << " (" << max_rel_dt_A_i <<  ", " << max_rel_dt_A_j <<  ", " << max_rel_dt_A_k << ")" << endl;
   ...
   for (int i_a = 0; i_a < nSide; i_a++)
   {
       ...
       for (int j_a = 0; j_a < nSide; j_a++)
       {
           ...
           for (int k_a = 0; k_a < nSide; k_a++)
           {
               ...
               double E_x_a = -dotFields[i_a][j_a][k_a].A_1;
               double E_y_a = -dotFields[i_a][j_a][k_a].A_2;
               double E_z_a = -dotFields[i_a][j_a][k_a].A_3;

               double B_x_a = (aux[i_a][j_a][k_a].dy_A_3 - aux[i_a][j_a][k_a].dz_A_2);
               double B_y_a = (aux[i_a][j_a][k_a].dz_A_1 - aux[i_a][j_a][k_a].dx_A_3);
               double B_z_a = (aux[i_a][j_a][k_a].dx_A_2 - aux[i_a][j_a][k_a].dy_A_1);
               ...
               for (int i_b = 0; i_b < nSide; i_b++)
               {
                   ...
                   for (int j_b = 0; j_b < nSide; j_b++)
                   {
                       ...
                       for (int k_b = 0; k_b < nSide; k_b++)
                       {
                           ...
                           double E_x_b = -dotFields[i_b][j_b][k_b].A_1;
                           double E_y_b = -dotFields[i_b][j_b][k_b].A_2;
                           double E_z_b = -dotFields[i_b][j_b][k_b].A_3;

                           double B_x_b = (aux[i_b][j_b][k_b].dy_A_3 - aux[i_b][j_b][k_b].dz_A_2);
                           double B_y_b = (aux[i_b][j_b][k_b].dz_A_1 - aux[i_b][j_b][k_b].dx_A_3);
                           double B_z_b = (aux[i_b][j_b][k_b].dx_A_2 - aux[i_b][j_b][k_b].dy_A_1);
